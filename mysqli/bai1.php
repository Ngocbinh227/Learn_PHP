<?php
 ...
 //insert
 $sql_stmt = "INSERT INTO students (studentID,FullName,DOB,Class,AVG)
...
$sql_stmt = "UPDATE students set AVG =8.5 where studentID = 'SV001'";
$result = mysqli_query($dbh, $sql_stmt); // Thực thi câu lệnh SQL
...
//delete
$sql_stmt = "DELETE from students where studentID = 'SV003'";
$result = mysqli_query($dbh, $sql_stmt); // Thực thi câu lệnh SQL
